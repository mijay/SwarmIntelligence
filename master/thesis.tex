...
\newlength \captionmarging
\setlength \captionmarging {\hoffset+\oddsidemargin+1.5em}
\newcommand{\capt}[1]{\vspace{-1em}\hspace{\captionmarging}\parbox{\textwidth}{\caption*{#1}}}
\NewEnviron{formula}{\begin{figure}[h]\begin{minipage}{\textwidth}\BODY\end{minipage}\end{figure}}
...
% нумерация приложений по арабски:
